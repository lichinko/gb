 ...
 * выбрать редактор кода по умолчанию (опция).
 * выбрать название главной ветки (опция).
...
*Не всё...Нужны минимальные настройки.*

* записать почту пользователя git config --giobal user.email "tmail"
* Записать имя пользователя   git config --giobal user. name "name"
